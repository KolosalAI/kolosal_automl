...
<body>
            ...
            <div class="content">
                <div class="content-inner">
                        ...
                        <div class="grid-2">
                            <div class="card">
                                ...
                                <div style="display:grid;gap:8px">
                                    ...
                                    <button class="quick-action" onclick="eTab('train');setTimeout(function(){eSubTab('train','single')},50)"><i class="ri-play-circle-line"></i><div><div class="qa-title">Train Model</div><div class="qa-desc">Train a single model manually</div></div></button>
                    ...
                    <div id="et-train" class="tab-panel">
                        <div class="sub-tabs">
                            <button class="sub-tab active" onclick="eSubTab('train','automl')"><i class="ri-magic-line"></i> AutoML</button>
                            ...
                            <button class="sub-tab" onclick="eSubTab('train','autotune')"><i class="ri-speed-line"></i> Auto-Tune</button>
                        ...
                        <!-- AutoML sub-panel -->
                        <div id="esp-train-automl" class="sub-panel active">
                        ...
                        <!-- Auto-Tune sub-panel -->
                        <div id="esp-train-autotune" class="sub-panel">
                            <div class="grid-2">
                                <div class="card">
    ...
    function eEnableButtons(){$('e-train-btn').disabled=false;$('e-ho-btn').disabled=false;$('e-ens-btn').disabled=false;$('e-at-btn').disabled=false;$('e-anomaly-btn').disabled=false;$('e-dr-btn').disabled=false}
